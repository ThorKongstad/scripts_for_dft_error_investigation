...
def main(neb_image_1: str, slab_for_1: str, neb_image_2: str, slab_for_2: str):
    ...
    energy_ensemble = [n_2 + s_1 - n_1 - s_2 for n_1, s_1, n_2, s_2 in zip(neb_1_ens, slab_1_ens, neb_2_ens, slab_2_ens)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('neb_image_1', help='reference format: db_path.db@row_nr')
    parser.add_argument('slab_for_1', help='reference format: db_path.db@row_nr')
