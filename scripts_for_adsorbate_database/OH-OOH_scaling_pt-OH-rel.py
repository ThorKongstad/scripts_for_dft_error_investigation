...
from scripts_for_adsorbate_database import sanitize, folder_exist, build_pd, adsorbate_reaction, metal_OOH_OH_ref_ractions, metal_ref_ractions, sd, mean
...
def scaling_plot(functional_list: Sequence[Functional], oh_reactions: Sequence[adsorbate_reaction], ooh_reactions: Sequence[adsorbate_reaction], png_bool: bool = False):
    ...
    save_name = 'reaction_plots/scaling_plot_OH-OOH_pt-OH-ref'
...
def main(slab_db_dir: list[str], adsorbate_db_dir: list[str], mol_db_dir: list[str], thermo_dynamics: bool = False):
    ...
    oh_ad_h2_water = metal_ref_ractions[0::3] #adsorption_OH_reactions[1::3] #[1,4,7,10,13,16]
    ooh_ad_h2_water = metal_OOH_OH_ref_ractions #metal_ref_ractions[1::3] #adsorption_OOH_reactions[1::3]
